  ...
  <div class="p-4 bg-gray-50 min-h-full flex flex-col">
    <div class="p-4 bg-white">
      <el-form :model="queryParams" ref="queryRef" :inline="true">
        <el-form-item label="未报价原因" prop="notQuotedReason">
          <el-select v-model="queryParams.notQuotedReason" placeholder="请选择" clearable style="width: 240px">
            <el-option label="超时未报价" value="1" />
            <el-option label="取消报价" value="2" />
          </el-select>
        </el-form-item>
    ...
    <div class="p-4 bg-white mt-4 flex-1">
      ...
      <div class="mt-4">
        <el-table v-loading="loading" :data="list" border :scrollbar-always-on="true" style="width: 100%">
          ...
          <el-table-column label="未报价原因" align="center" prop="noQuotedReason" width="150">
          </el-table-column>
...
<script setup>
import { notQuotedList } from "@/api/deal";
...
function handleExport() {
  proxy.download(
    "/zoom-fleet-manager/quotationTodo/exportNotQuotedList",
    {
      ...queryParams,
      exportType: 1,
    },
