...
public class Encryption {
   ...
   private static BASE64Encoder encodeBase64= new BASE64Encoder();
     ...
     */
    public static String doContentMD5(String str) throws SysAppException {
        byte[] md5Bytes = null;
        ...
        try {
            ...
            SysAppException ex = new SysAppException(ErrorEnum.BUSINESS_ERR.getCode(), "不支持此算法");
            ex.initCause(e);
            throw ex;
        } catch (UnsupportedEncodingException e) {
            SysAppException ex = new SysAppException(ErrorEnum.BUSINESS_ERR.getCode(), "不支持的字符编码");
            ex.initCause(e);
            throw ex;
        }
        return contentMD5;
     ...
     * @throws Exception 加密过程中的异常信息
     */
    public static String doSignatureBase64(String message, String secret) throws SysAppException {
        ...
        try {
            ...
            SysAppException ex = new SysAppException(ErrorEnum.BUSINESS_ERR.getCode(), "无效的密钥规范");
            ex.initCause(e);
            throw ex;
        }
        return digestBase64;
     ...
     * @return
     */
    public static String Hmac_SHA256(String message,String key) throws SysAppException {
        byte[] rawHmac=null;
        try {
            ...
            SysAppException ex = new SysAppException(ErrorEnum.BUSINESS_ERR.getCode(), "hash散列加密算法报错");
            ex.initCause(e);
            throw ex;
        }finally {
     ...
     * MD5加密32位
     */
    public static String MD5Digest(String text) throws SysAppException {
        byte[] digest=null;
        try {
