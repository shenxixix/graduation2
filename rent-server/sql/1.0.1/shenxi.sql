...
CREATE TABLE rent_enterprise_station (
  ...
  CONSTRAINT pk_rent_enterprise_station PRIMARY KEY (station_id)
);
COMMENT ON COLUMN rent_enterprise_station.station_id IS '企业id';
COMMENT ON COLUMN rent_enterprise_station.station_name IS '企业名称';
COMMENT ON COLUMN rent_enterprise_station.enterprise_id IS '租赁企业id';
COMMENT ON COLUMN rent_enterprise_station.latitude IS '纬度';
COMMENT ON COLUMN rent_enterprise_station.longitude IS '经度';
COMMENT ON COLUMN rent_enterprise_station.location IS '位置信息';
COMMENT ON COLUMN rent_enterprise_station.city_code IS '所属城市代码';
COMMENT ON COLUMN rent_enterprise_station.city_name IS '所属城市';
COMMENT ON COLUMN rent_enterprise_station.phone_num IS '联系电话';
COMMENT ON COLUMN rent_enterprise_station.station_pics IS '门脸照片';
COMMENT ON COLUMN rent_enterprise_station.del_flag IS '删除状态，0：未删除，1：已删除';
COMMENT ON COLUMN rent_enterprise_station.opt_user_id IS '关闭操作人ID';
COMMENT ON COLUMN rent_enterprise_station.opt_timestamp IS '操作时间';
COMMENT ON TABLE rent_enterprise_station IS '企业站点表(用于取还车)';
